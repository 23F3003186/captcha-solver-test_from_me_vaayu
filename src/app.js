...
window.onload = function() {
    const captchaUrl = getUrlParameter('url') || 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAAKCAYAAACNMs+9AAAAFElEQVQYV2NkQAP/Gf4bBjCqAEMAAHQDAh0U8PYAAAAASUVORK5CYII=';
    displayCaptcha(captchaUrl);
};
